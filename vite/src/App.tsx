...
import type { Message, Session, WebsocketPayload } from "./types";
...
export default function App() {
    ...
    useEffect(() => {
        (async () => {
            ...
            // message to agent.
            const url = import.meta.env.VITE_INITDAI_GUEST_SESSION_URL;
            const res = await fetch(`${url}/guest`, {
                ...
                body: JSON.stringify({
                    ...
                    publicAccessToken: import.meta.env
                        .VITE_INITDAI_PUBLIC_ACCESS_TOKEN,
                }),
            });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const url = import.meta.env.VITE_INITDAI_HTTP_URL;
